...
<script type="text/javascript">
	...
	function showData(){
		...
		$.getJSON('<?= site_url('Admin/Daftar_pesanan/showData')?>', function(data) {
			$.each(data,function(i,item){
				...
				if (s==1) {
					s="Tunggu Konfirmasi";
					buttonAksi ='<button type="button" class="btn btn-primary" name="aksi" onclick="konfirmData('+faktur+')">Konfirmasi</button>';
					buttonDelete ='<button type="button" class="btn btn-danger" name="delete" onclick="deleteData('+faktur+')">Hapus</button>';
				}else if(s==2){
					s="Sedang Diproses";
					buttonAksi ='<button type="button" class="btn btn-primary" name="aksi" onclick="kirimData('+faktur+')">Selesai</button>';
					buttonDelete ='<button type="button" class="btn btn-danger" name="delete" onclick="deleteData('+faktur+')">Hapus</button>';
	...
	function konfirmData(faktur){
		$.ajax({
			url:"<?= site_url('/Admin/Daftar_pesanan/konfirmData')?>",
			method:"post",
			data:{
				faktur:faktur
			},
	...
	function kirimData(faktur){
			$.ajax({
				url:"<?= site_url('/Admin/Daftar_pesanan/kirimData')?>",
				method:"post",
				data:{
					faktur:faktur
				},
	...
	function deleteData(faktur){
		$.ajax({
			url:"<?= site_url('/Admin/Daftar_pesanan/deleteData')?>",
			method:"post",
			data:{
				faktur:faktur
			},
	...
	function detailData(faktur){
		...
		var gtotal=0;
		$.ajax({
			url:"<?= site_url('/Admin/Daftar_pesanan/detailData')?>",
			method:"post",
			dataType:'json',
			data:{
				faktur:faktur
