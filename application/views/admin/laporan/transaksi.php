		...
		<div class="row">
          ...
          <div class="box box-primary ">
            ...
            <div class="box-body">
   	 		 ...
   	 		 <div class="col-md-6">
				 <a class="btn btn-primary" href="<?= site_url('Admin/Cetak/laporan_transaksi?tawal='.$_GET['tawal']).'&takhir='.$_GET['takhir'] ?>">
   	 			...
   	 			<div class="table-responsive scroll">
   	 				<table class="table table-hover table-bordered table-striped" id="myTable">
   	 					...
   	 					<tbody>
   	 						<?php
							$CI =& get_instance();
							$CI->load->model('Mtransaksi');
							if (isset($_GET['tawal'])) {
								$result = $CI->Mtransaksi->get_where_tran($_GET['tawal'],$_GET['takhir']);
								...
								$date = date("Y-m-d");
								$results = $CI->Mtransaksi->get_where_tran($date,$date);
