		...
		<div class="row">
          ...
          <div class="box box-primary ">
            ...
            <div class="box-body">
   	 		 ...
   	 		 <div class="col-md-6">
				 <a class="btn btn-primary" href="<?= site_url('Admin/Cetak/laporan_labarugi?tawal='.$_GET['tawal']).'&takhir='.$_GET['takhir'] ?>">
   	 		...
   	 		<div class="col-lg-12 ">
   	 			...
   	 			<div class="table-responsive scroll">
   	 				<table class="table table-hover table-bordered table-striped" id="myTable">
							...
							$labarugi="";
							$CI =& get_instance();
							$CI->load->model('Mlabarugi');
							if (isset($_GET['tawal'])) {

								$result = $CI->Mlabarugi->get_where_tran($_GET['tawal'],$_GET['takhir']);
								foreach ($result as $rows){
									...
									<tr>
										...
										<td><?= $rows->barang ?></td>
										<td><?= $j = $rows->jumlah ?></td>
										<td><?= $hbeli = $rows->harga_beli ?></td>
										<td><?= $hjual = $rows->harga_jual ?></td>
								...
								$result = $CI->Mlabarugi->get_where_tran(date("Y-m-d"),date("Y-m-d"));
									...
									<tr>
										...
										<td><?php
											...
											echo $date;
							 				...
							 				<td><?= $hbeli = $row->harga_beli ?></td>
							 				<td><?= $hjual = $row->harga_jual ?></td>
   	 				...
   	 				<div class="label label-primary pull-left" style="margin-top:20px">
   	 					<h4>Total Laba : <?= rp($tolaba)?></h4>
   	 				</div>
					<div class="clearfix">
					</div>
				  <div class="label label-primary pull-left" style="margin-top:20px">
					   	<h4>Total Rugi : <?= rp($torugi)?></h4>
					</div>
